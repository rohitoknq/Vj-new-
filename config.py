...
BOT_TOKEN = environ.get("BOT_TOKEN", "7791477566:AAGQAq7iY0m5lv3Bsq4uGlmZC_r3gu7O398")
...
# Channel Information
LOG_CHANNEL = int(environ.get("LOG_CHANNEL", "-1002334590710"))
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://vj-file-store-yt7c.onrender.com/")
